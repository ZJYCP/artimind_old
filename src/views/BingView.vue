    ...
    <div class="body" ref="scrollRef">
        ...
        <div v-else class="questions">
            <div v-for="(item,index) in conversationList" :key="index" class="item slide-animation">
                <div class="question">
                    <el-avatar class="flexShrink" :size="28" :icon="UserFilled" :src="require('../assets/my.png')"
                ...
                <div class="answer">
                    ...
                    <div v-if="item.assistant" style="flex: 1">
                        ...
                        <div v-if="!item.isError" class="operation">
                            ...
                            <div @click="onCollection(item,index)" class="operationItem" v-show="!(item.isCollection)"
        ...
        <div class="footer">
            <div class="footer-bar">
                <el-input @keyup.enter="onSubmit" v-model="input" :placeholder="aiPrompt" :disabled="aiLoading"></el-input>
    ...
    setup() {
        ...
        function webSocket({messages, index}) {
            ...
            if (typeof (WebSocket) == "undefined") {
                ...
                let socketUrl = "ws://rtx4.vmip.com.cn:36102/chat/api/BING/" + localStorage.getItem('token')
                ...
                socket.value.onmessage = function (msg) {
                    try {
                        if (msg.data === "SEND_ERR") {
                            socket.value.close();
                            conversationList.value[index].assistant = "哦豁!网络貌似出了点小问题"
                            conversationList.value[index].isError = true
                            ...
                            socket.value.close();
                            conversationList.value[index].assistant = "哦豁!回复时间过长已自动截停"
                            conversationList.value[index].isError = true
                        } else {
        ...
        function scrollToTheBottom() {
            setTimeout(() => scrollRef.value.scrollTop = scrollRef.value.scrollHeight, 100);
        }
